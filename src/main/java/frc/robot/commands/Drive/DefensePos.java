...
public class DefensePos extends Command {
    ...
    public DefensePos(Swerve s_Swerve, DoubleSupplier x, DoubleSupplier y, DoubleSupplier rotationSup, BooleanSupplier robotCentricSup) {
