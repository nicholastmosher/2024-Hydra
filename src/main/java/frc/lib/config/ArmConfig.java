...
public class ArmConfig {
    ...
    public ArmConfig(int rightMotor, int leftMotor, PidConfig pid, Rotation2d shootAngle, Rotation2d intakeAngle, Rotation2d ampAngle, double scalingFactor, Rotation2d offset) {
